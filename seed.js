...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Slingerland COB', img: '', category: categories[1], price: 0},
    {name: 'George Way Coppertone', img: '', category: categories[1], price: 0},
    ...
    {name: 'Istanbul Dark Hats', img: '', category: categories[2], price: 0},
